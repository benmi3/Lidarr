...
namespace NzbDrone.Core.Indexers.Deemix
{
    public class DeemixRequestGenerator : IIndexerRequestGenerator
    {
        ...
        public virtual IndexerPageableRequestChain GetRecentRequests()
        {
            ...
            pageableRequests.Add(GetRequest("eminem"));
        ...
        {
            var pageableRequests = new IndexerPageableRequestChain();
            pageableRequests.Add(GetRequest(string.Format("artist:\"{0}\"%20album:\"{1}\"", searchCriteria.ArtistQuery, searchCriteria.AlbumQuery)));
            return pageableRequests;
        }
